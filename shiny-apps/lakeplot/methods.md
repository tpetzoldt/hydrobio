...
Oxygen saturation is given by the ratio of the actuall oxygen concentration and the oxygen satuiiration concentration at the given temperature. The saturation concentration can be estimated as a function of watertemperature and barometric pressure using the equation by Mortimer (1981):
...
where $T$ is the temperature in degrees Celsius, and $p$ is the air pressure in hecto Pascal. The resulting saturation concentration is in units of gO/m$^3$ or mgO/l.
