...
where $T$ is the temperature in degrees Celsius, and $p$ is the air pressure in 
hectopascal. The resulting saturation concentration is in units of gO/m$^3$ or mgO/l.
